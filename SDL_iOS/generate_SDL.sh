...
if [ ! -z "$1" ] ; then
  ...
  xcodebuild -target "Static Library-iOS" -sdk iphonesimulator -configuration Release -project SDL2/Xcode/SDL/SDL.xcodeproj
...
xcodebuild -target "Static Library-iOS" -sdk iphoneos -configuration Release -project SDL2/Xcode/SDL/SDL.xcodeproj
...
if [ ! -z "$1" ] ; then
  lipo -create -output ../lib/iOS/libSDL2.a SDL2/Xcode/SDL/build/Release-iphoneos/libSDL2.a SDL2/Xcode/SDL/build/Release-iphonesimulator/libSDL2.a
  ...
  cp SDL2/Xcode/SDL/build/Release-iphoneos/libSDL2.a ../lib/iOS/libSDL2.a
